        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                ...
                @if ($fundraising->is_active)
                    <span class="text-white font-bold bg-green-500 sm:rounded-lg w-fit p-5">
                    Fundraising sudah aktif dapat menerima donasi.
                </span>
                    
                @else
                    
                <div class="flex flex-row justify-between">
                    <span class="text-white font-bold bg-red-500 sm:rounded-lg w-fit p-5">
                    Fundraising belum di setujui oleh admin (owner).
                </span>
                @role('owner')
