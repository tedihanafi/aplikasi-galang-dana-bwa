...
@section('title', 'Details | Ayo Donasi')
@section('content')
    <section class="max-w-[640px] w-full min-h-screen mx-auto flex flex-col bg-white overflow-x-hidden">
        ...
        <div class="flex flex-col z-30">
            ...
            <div id="content" class="w-full bg-white rounded-t-[40px] flex flex-col gap-5 p-[30px_24px_120px]">
                <div class="flex flex-col gap-[10px]">
                    ...
                    <div class="flex items-center gap-2">
                        <div class="w-9 h-9 flex shrink-0 rounded-full overflow-hidden">
                            <img src="{{ Storage::url($fundraising->fundraiser->user->avatar) }}" alt="foto avatar"
                ...
                {{-- ini yang bermasalah ingin menampilkan --}}
                ...
                @empty
                    <p>Belum ada donasi yang di serahkan ke pihak yang membutuhkan.</p>
                @endforelse
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        @empty
                            <p>Belum ada yang berdonasi, Ayo segera berdonasi !</p>
                        @endforelse
        ...
        {{-- jika belum sampai target maka masih bisa donasi --}}
        @if (!$goalReached)
