...
{{-- contoh penggunaan untuk halaman ini saja bisa juga untuk css --}}
{{-- js di file app.blade.php di bungkus dengan before-after --}}
{{-- berhubung di bawah di push after-script, maka js di bawah di load setelah js yan di bungkus di file app --}}

{{-- @push('after-script')
    <script src="{{ asset('js/file-tambahan.js') }}"></script>
@endpush --}}
