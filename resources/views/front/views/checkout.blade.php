       ...
       <section class="max-w-[640px] w-full min-h-screen mx-auto flex flex-col bg-[#FCF7F1] overflow-x-hidden">
           <div class="header flex flex-col overflow-hidden h-[220px] relative">
               ...
               <div class="flex items-center px-4 my-auto gap-[14px]">
                   ...
                   <div class="flex flex-col gap-1">
                       ...
                       <p class="text-xs leading-[18px]">Target <span class="font-bold text-[#FF7815]">Rp {{ number_format($fundraising->target_amount, 0, ',', '.') }}</span>
                       </p>
                   </div>
               </div>
           </div>
           <div class="flex flex-col z-30">
               <div id="content"
                   ...
                   <form action="{{route('front.store', ['fundraising' => $fundraising->slug, 'totalAmountDonation' => $totalAmountDonation])}}" method="POST" enctype="multipart/form-data" class="flex flex-col gap-5">
                    @csrf
                    <div class="flex flex-col gap-[10px]">
                           ...
                           <div class="bg-[#E8E9EE] w-full flex items-center rounded-2xl p-[14px_16px] gap-[10px]">
                               ...
                               <p class="font-semibold">{{ number_format($totalAmountDonation, 0, ',', '.') }}</p>
                           </div>
