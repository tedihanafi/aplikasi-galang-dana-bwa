...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('admin')->name('admin.')->group(function() {
        ...
        ->middleware('role:owner')->except('index'); // method di controler tersebut crud hanya bisa owner kecuali method index
        
        // route ini tidak di lindungi karna hanya baru mendaftar menjadi fundraiser. setelah di setujui oleh admin baru bisa buka route di bawah
        ...
        // buat function activate_fundraising di controler 
